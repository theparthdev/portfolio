            ...
            <Card className="glass-card border-0 fade-up stagger-1">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  <h4 className="font-medium text-primary">Bachelor of Computer Applications</h4>
                  <p className="text-muted-foreground">Panipath Institute of Engineering and Technology</p>
            ...
            <Card className="glass-card border-0 fade-up stagger-2">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">DNK Media - Siyadnk Software Pvt. Ltd.</p>
                  <p className="text-sm text-muted-foreground">Full-stack Development Focus</p>
                </div>
              </CardContent>
            </Card>
          </div>
