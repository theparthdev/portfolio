      ...
      <div className="container mx-auto px-6 text-center z-20 relative">
        <div className="max-w-4xl mx-auto fade-up">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto fade-up stagger-2">
            Computer Applications student with hands-on experience in full-stack
            development, passionate about creating innovative solutions with
          ...
          <div className="flex justify-center gap-6 mb-16 fade-up stagger-3">
            <a
              href="https://github.com/theparthdev"
              target="_blank"
            ...
            <a
              href="mailto:namberdarparth@gmail.com"
              className="text-muted-foreground hover:text-primary transition-colors"
            >
